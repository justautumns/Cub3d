...
/*   Updated: 2024/07/20 10:46:15 by mtrojano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_up_valid(t_data *d)
{
	...
	if (d->map[map_y][map_x] == '1')
		return (-1);
	map_x = (int)(d->player_x + DIST_FROM_WALL * MOVE_SPEED
			* cos(d->player_angle - (20 * DEGREE))) / TILE_SIZE; // to not pass through corners
	map_y = (int)(d->player_y + DIST_FROM_WALL * MOVE_SPEED
...
int	move_left_valid(t_data *d)
{
	...
	if (d->map[map_y][map_x] == '1')
		return (-1);
	map_x = (int)(d->player_x + DIST_FROM_WALL * MOVE_SPEED
			* cos(angle_left - (20 * DEGREE))) / TILE_SIZE; // to not pass through corners
	map_y = (int)(d->player_y + DIST_FROM_WALL * MOVE_SPEED
...
int	move_right_valid(t_data *d)
{
	...
	if (d->map[map_y][map_x] == '1')
		return (-1);
	map_x = (int)(d->player_x + DIST_FROM_WALL * MOVE_SPEED
			* cos(angle_right - (20 * DEGREE))) / TILE_SIZE; // to not pass through corners
	map_y = (int)(d->player_y + DIST_FROM_WALL * MOVE_SPEED
