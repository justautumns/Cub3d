...
/*   Updated: 2024/09/02 16:28:35 by mtrojano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_tex_data(t_data *d, int i)
{
	...
	while (i < 4)
	{
		...
		if (d->img_x != 64 || d->img_y != 64)
		{
			d->tex->textures[i + 1] = NULL;
			d->tex->tex_data[i] = NULL;
			return (ft_error("Error : Texture size does not match\n"));
		}
